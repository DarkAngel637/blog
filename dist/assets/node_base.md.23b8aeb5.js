import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.7204edfa.js";const C=JSON.parse('{"title":"node and npm","description":"","frontmatter":{},"headers":[],"relativePath":"node/base.md","filePath":"node/base.md"}'),p={name:"node/base.md"},o=l(`<h1 id="node-and-npm" tabindex="-1">node and npm <a class="header-anchor" href="#node-and-npm" aria-label="Permalink to &quot;node and npm&quot;">​</a></h1><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 本地安装</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6F42C1;">nvm</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">--help</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 显示命令行帮助信息</span></span></code></pre></div><h3 id="配置环境变量" tabindex="-1">配置环境变量 <a class="header-anchor" href="#配置环境变量" aria-label="Permalink to &quot;配置环境变量&quot;">​</a></h3><h4 id="光配置-node" tabindex="-1">光配置 node <a class="header-anchor" href="#光配置-node" aria-label="Permalink to &quot;光配置 node&quot;">​</a></h4><h4 id="安装nvm-之后配置环境变量" tabindex="-1">安装nvm 之后配置环境变量 <a class="header-anchor" href="#安装nvm-之后配置环境变量" aria-label="Permalink to &quot;安装nvm 之后配置环境变量&quot;">​</a></h4><p>nvm 官网链接 : <a href="https://github.com/coreybutler/nvm-windows/releases" target="_blank" rel="noreferrer">https://github.com/coreybutler/nvm-windows/releases</a> 2. 点击下一步安装到 D:\\NVM 下</p><ol start="3"><li>先在D:\\NVM 下创建nodejs文件夹，然后将路径设置如下：D:\\NVM\\nodejs 4、点击next 一直点击 完成安装；</li></ol><p>5、找到指定nvm打开 settings.txt ,添加以下两行文本：</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">node_mirror:</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">https://npm.taobao.org/mirrors/node/</span></span>
<span class="line"></span>
